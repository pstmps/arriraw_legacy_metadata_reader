...
class Cdi(BinaryFileDTO):
    ...
    def __init__(self, file, fields_to_extract=None):
        ...
        self.fields = [
            ...
            {
                "name": "SystemImageTimeZoneOffset",
                "offset": 0x0184,
                "datatype": "offset",
                "prefix": "UTC+",
            },  # Documentation unclear, would be great to have more examples
            {
                "name": "SystemImageTimeZoneDST",
                "offset": 0x0188,
                "datatype": "offset",
                "prefix": "+",
            },  # Documentation unclear, would be great to have more examples
            ...
            {
                "name": "MasterTCFrameCount",
                "offset": 0x01AC,
                "datatype": "I",
                "endianness": "<",
            },
            {
                "name": "MasterTCTimeBase",
                "offset": 0x01B0,
                "datatype": "float",
                "decimals": 3,
                "endianness": "<",
