...
class CDI(BinaryFileDTO):
    def __init__(self, file, fields_to_extract=None):
        ...
        self.fields = [
            ...
            {'name': 'SystemImageCreationTest',     'offset': 0x017C, 'datatype': 'I', 'endianness': '<'},
            {'name': 'SystemImageCreationDate',     'offset': 0x017C, 'datatype': 'date'},
            {'name': 'SystemImageCreationTime',     'offset': 0x0180, 'datatype': 'time'},
            {'name': 'SystemImageTimeZoneOffset',   'offset': 0x0184, 'datatype': 'offset', 'prefix': 'UTC+'}, # Documentation unclear, would be great to have more examples
            {'name': 'SystemImageTimeZoneDST',      'offset': 0x0188, 'datatype': 'offset', 'prefix': '+'},  # Documentation unclear, would be great to have more examples
            {'name': 'ExposureTime',                'offset': 0x018C, 'datatype': 'float', 'unit': 'ms', 'decimals': 3, 'endianness': '<'},
            {'name': 'ShutterAngle',                'offset': 0x0190, 'datatype': 'float', 'decimals': 2, 'endianness': '<'},
            {'name': 'SensorFPS',                   'offset': 0x01A0, 'datatype': 'float', 'decimals': 3, 'endianness': '<'},
            {'name': 'ProjectFPS',                  'offset': 0x01A4, 'datatype': 'float', 'decimals': 3, 'endianness': '<'},
            {'name': 'MasterTC',                    'offset': 0x01A8, 'datatype': 'timecode'},
            {'name': 'MasterTCFrameCount',          'offset': 0x01AC, 'datatype': 'I', 'endianness': '<'},
            {'name': 'MasterTCTimeBase',            'offset': 0x01B0, 'datatype': 'float', 'decimals': 3, 'endianness': '<'},
            ...
            {'name': 'MirrorShutterRunning',        'offset': 0x02C4, 'datatype': 'bits', 'endianness': '<', 'bit_position': 0, 'mapping': self.unit_mapping['MirrorShutterRunning']},
            {'name': 'Vari',                        'offset': 0x02C4, 'datatype': 'bits', 'endianness': '<', 'bit_position': 1, 'mapping': self.unit_mapping['Vari']},
